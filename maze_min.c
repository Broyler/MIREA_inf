...
Windows:
LOCAL: gcc -o BuildMin/maze_min.exe maze_min.c -IC:\w64devkit\include\SDL2 -LC:\w64devkit\lib -w -Wl,-subsystem,windows -lmingw32 -lSDL2 -O3 -march=native -mtune=native
MULTI: gcc -o BuildMin/maze_min.exe maze_min.c -IC:\w64devkit\include\SDL2 -LC:\w64devkit\lib -w -Wl,-subsystem,windows -lmingw32 -lSDL2 -O3

Linux:
LOCAL: gcc -o maze_min.a maze_min.c -w -lSDL2 -O3 -march=native -mtune=native
MULTI: gcc -o maze_min.a maze_min.c -w -lSDL2 -O3
...
int main(int argc, char *argv[]) {
    ...
    SDL_Surface* image = SDL_LoadBMP("win.bmp");
    ...
    while (run) {
        ...
        if (isGameWon) {
            SDL_RenderCopy(renderer, imageTex, NULL, &winMsgRect);
        }
